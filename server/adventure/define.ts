// What an adventure is made of, as data the engine runs (see engine.ts):
//
//   Adventure
...
import type { Attack, CharacterDef } from '../../src/lib/adventure/characters';
import type { Cue, Shot } from '../../src/lib/game/chat';
